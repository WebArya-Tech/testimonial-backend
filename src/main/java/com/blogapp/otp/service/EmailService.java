...
public class EmailService {
    ...
    public void sendContactUsUserConfirmation(String to, String fullName, String subjectName, String messageText) {
        String subject = "We've received your message — Astar Classes";
        String htmlBody = """
                <!DOCTYPE html>
                <html>
                <head>
                  <meta charset="utf-8">
                  <title>Astar Classes – Message Received</title>
                  <style>
                    body {
                      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                      background-color: #f8fafc;
                  ...
                  <div class="wrapper">
                    <div class="container">
                      ...
                      <div class="content">
                        ...
                        <div class="signature">
                          <p>Warm regards,</p>
                          <p><strong>The Astar Classes Team</strong><br>
    ...
    public void sendScheduleDemoUserConfirmation(
        ...
        String subject = "Your demo class is booked! — Astar Classes";
        String htmlBody = """
                <!DOCTYPE html>
                <html>
                <head>
                  <meta charset="utf-8">
                  <title>Astar Classes – Demo Booking Confirmed</title>
                  <style>
                    body {
                      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                      background-color: #f8fafc;
                ...
                <body>
                  <div class="wrapper">
                    <div class="container">
                      ...
                      <div class="content">
                        <div class="greeting">Dear %s &amp; %s,</div>
                        <p class="intro">
                        ...
                        <div class="signature">
                          <p>We look forward to welcoming you to Astar Classes!</p>
                          <p><strong>The Astar Classes Team</strong><br>
                          Supporting Your Academic Journey</p>
                        </div>
                      </div>
                ...
                """.formatted(parentName, studentName, studentName, gradeName, boardName, preferredDate, preferredTime);
        sendEmail(to, subject, htmlBody);
    }
}
